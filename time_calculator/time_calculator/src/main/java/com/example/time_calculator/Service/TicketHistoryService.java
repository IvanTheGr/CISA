...
import com.example.time_calculator.dto.CustomerRatingDTO;
...
import com.example.time_calculator.dto.TicketHistoryItemDTO;
...
public class TicketHistoryService {
    ...
    public TicketHistoryResponseDTO getMyHistory(String login) {
        ...
        List<Map<String, Object>> rows = jdbcTemplate.queryForList(
                ...
                SELECT
                    ...
                    COALESCE(i.state, 'SUBMITTED') AS incident_state
        ...
        List<TicketHistoryItemDTO> pendingApproval = new ArrayList<>();
        List<TicketHistoryItemDTO> approved = new ArrayList<>();

        for (Map<String, Object> row : rows) {
            Long ticketId = toLong(row.get("id"));
            CustomerRatingDTO rating = loadCustomerRating(ticketId);

            TicketHistoryItemDTO item = TicketHistoryItemDTO.builder()
                    .id(ticketId)
                    ...
                    .customerRatingComment(rating != null ? rating.getComment() : "-")
                    .ratingCustomerName(rating != null ? rating.getCustomerName() : "-")
    ...
    @Transactional(readOnly = true)
    public TicketHistoryDetailDTO getDetail(Long ticketId, String login) {
        ResUsers currentUser = resUsersRepository
                .findByLoginAndActiveTrue(login)
                .orElseThrow(() -> new RuntimeException("User not found"));
        ...
        if (ticket.getUserId() == null || !ticket.getUserId().equals(currentUser.getId())) {
            throw new RuntimeException("You are not allowed to view this ticket history");
        }
    ...
    private CustomerRatingDTO mapRatingRow(Map<String, Object> row) {
        ...
        /*
         * FIX:
         * Jangan langsung ambil customer_name karena kadang isinya partner_id, contoh 359.
         * Ambil partner_id/customer_name numeric lalu lookup ke res_partner.
         */
    ...
    private String resolveRatingCustomerName(Map<String, Object> row) {
        /*
         * Prioritas 1:
         * Ambil dari hasil JOIN res_partner rp.name AS rating_partner_name.
         */
        String joinedName = firstStringIgnoreCase(row,
                "rating_partner_name"
        );
        ...
        /*
         * Prioritas 2:
         * Ambil partner_id asli dari tabel rating.
         */
        ...
        /*
         * Prioritas 3:
         * Kalau customer_name ternyata isinya angka seperti 359,
         * anggap itu ID res_partner.
         */
        if (partnerId == null) {
        ...
        /*
         * Fallback terakhir:
         * Kalau memang sudah ada nama text, pakai itu.
         */
    ...
    private Integer normalizeRatingNumber(Double value) {
        ...
        /*
         * Kalau rating dari Odoo skalanya 0 - 10,
         * kita ubah ke 0 - 5.
         */
        ...
        /*
         * Kalau rating ternyata 0 - 100, contoh 80, ubah ke 4.
         */
